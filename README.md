...
```bash
# 克隆仓库
git clone https://github.com/sanxiaozi/aireading.git
cd aireading
...
[![Star History Chart](https://api.star-history.com/svg?repos=sanxiaozi/aireading&type=Date)](https://star-history.com/#sanxiaozi/aireading&Date)
